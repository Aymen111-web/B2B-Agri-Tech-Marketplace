    ...
    <div class="w-full max-w-[430px] bg-white rounded-[24px] shadow-xl overflow-hidden border border-[#E2E8F0] relative">
      ...
      <div class="p-6 md:p-8 space-y-6">
        ...
        <div class="flex items-center gap-2 pt-1 border-t border-gray-100">
          ...
          <h1 class="text-[18px] font-extrabold text-[#0B57D0]">Sign In to Q M T - A G R I G A T E</h1>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          <div>
            <label class="text-[12px] font-bold text-[#1E2328] block mb-1">Mobile Phone Number</label>
